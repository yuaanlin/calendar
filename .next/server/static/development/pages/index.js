  ...
  render() {
    if (this.props.event instanceof _classes__WEBPACK_IMPORTED_MODULE_2__["Event"]) {
      if (this.props.event.isEmpty) {
        ...
        if (this.props.event.ignore == true) return __jsx(_material_ui_core_Tooltip__WEBPACK_IMPORTED_MODULE_3___default.a, {
  ...
  render() {
    if (this.state.userdata.calendars != undefined) {
      ...
      return __jsx(_material_ui_core_Container__WEBPACK_IMPORTED_MODULE_2___default.a, {
        ...
        defaultValue: this.state.selectedEvent.startTime.getFullYear() + "/" + (this.state.selectedEvent.startTime.getMonth() + 1) + "/" + this.state.selectedEvent.startTime.getDate(),
        margin: "dense",
        id: "name",
        ...
        defaultValue: this.state.selectedDay.getFullYear() + "/" + (this.state.selectedDay.getMonth() + 1) + "/" + this.state.selectedDay.getDate(),
        margin: "dense",
        id: "name",
        onChange: this.handleDateChange,
        label: "\u65E5\u671F",
