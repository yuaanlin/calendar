    ...
    value: function render() {
      if (this.state.userdata.calendars != undefined) {
        ...
        if (_babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_0___default()((DayA - DayB) / 3600000) < 0) {
          ...
          if (_babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_0___default()((DayA - DayB) / 3600000) == 0) dayDescription = "今天";else if (_babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_0___default()((DayA - DayB) / 3600000) == 24) dayDescription = "明天";else if (_babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_0___default()((DayA - DayB) / 3600000) == 48) dayDescription = "後天";else dayDescription = _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_0___default()((DayA - DayB) / 3600000 / 24);
        }
...
//# sourceMappingURL=index.js.1fb887f6fd9f843239f9.hot-update.js.map