...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(index, [{
    ...
    value: function openEventCreateDialog() {
      console.log(this.state.selectedDay.getFullYear() + "/" + (this.state.selectedDay.getMonth() + 1) + "/" + this.state.selectedDay.getDate());
      this.setState({
        creatingEvent: true,
        inputing: {
            ...
            case 0:
              ...
              newdata.calendars.map(function (calendar) {
                if (calendar.title == _this3.state.inputing.calendar) {
                  calendar.events.push(new _classes__WEBPACK_IMPORTED_MODULE_14__["Event"]({
...
//# sourceMappingURL=index.js.f0a1ac3b9884fcf84071.hot-update.js.map