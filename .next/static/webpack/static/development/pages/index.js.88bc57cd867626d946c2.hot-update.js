...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(index, [{
    ...
    value: function openEventCreateDialog() {
      console.log(this.state.selectedDay.getFullYear() + "/" + this.state.selectedDay.getMonth() + "/" + this.state.selectedDay.getDate());
      this.setState({
        creatingEvent: true,
        inputing: {
...
//# sourceMappingURL=index.js.88bc57cd867626d946c2.hot-update.js.map