    ...
    value: function render() {
      if (this.props.event instanceof _classes__WEBPACK_IMPORTED_MODULE_9__["Event"]) {
        if (this.props.event.isEmpty) {
          return EmptySections(this.props.event.startTime, this.props.event.endTime).map(function (emptyCard) {
            return emptyCard;
          });
        } else {
          var style = {
...
//# sourceMappingURL=index.js.0f6cbe9dea472a9b9003.hot-update.js.map